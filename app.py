...
if "C-Total Heat Rated" in active_df.columns:
 heating_capacities = sorted(
 active_df["C-Total Heat Rated"].dropna().unique().tolist()
 )
selected_heating = debar.selectbox(
 "Heating Capacity (kW) (Optional):", options=["All"] + heating_capacities
)
